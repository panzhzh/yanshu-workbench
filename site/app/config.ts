...
export const UI_COPY = {
  zh: {
    ...
    mobileMenu: "打开导航",
    closeMenu: "关闭导航",
    collapseNavigation: "收起左侧导航",
    expandNavigation: "展开左侧导航",
    skipToContent: "跳到正文",
    navLabel: "站点导航",
    navDirectory: "导航",
    navHome: "首页",
    ...
    title: "论文重构",
    subtitle: "选择论文类型、正文字数限制与附录规则，再使用四步真实 Prompt 完成重构。",
    ...
    wordLimitOff: "无特殊规定",
    noWordLimitHint:
      "关闭后不显示 04，四步 Prompt 也不包含正文总数或章节预算。",
    words: "词",
    appendix: "附录设置",
    appendixOn: "允许附录",
    appendixOff: "不含附录",
    ...
    workflowTitle: "四步重构工作流",
    workflowBody:
      "四份真实模板已整理为可配置 Prompt；每步独立支持中英文，并同步当前论文设置。",
  ...
  en: {
    ...
    collapseNavigation: "Collapse left navigation",
    expandNavigation: "Expand left navigation",
    ...
    noWordLimitHint:
      "When disabled, section 04 is hidden and all four prompts omit the main-text total and section budgets.",
    words: "words",
    appendix: "Appendix",
    ...
    workflowEyebrow: "RECONSTRUCTION WORKFLOW",
    workflowTitle: "Four-step reconstruction workflow",
    workflowBody:
      "The four source templates are now production prompts. Each step supports independent bilingual output and the current planner variables.",
